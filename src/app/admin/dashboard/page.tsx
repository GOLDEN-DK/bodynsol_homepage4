    ...
    <div className="p-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link href="/admin/banners" className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow">
            <h3 className="font-bold text-gray-800 mb-2">배너 관리</h3>
            <p className="text-gray-600 text-sm">웹사이트 배너를 추가하고 관리합니다.</p>
          </Link>
          <Link href="/admin/media" className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow">
            <h3 className="font-bold text-gray-800 mb-2">미디어 관리</h3>
            <p className="text-gray-600 text-sm">이미지와 비디오를 업로드하고 관리합니다.</p>
          </Link>
        </div>
      </div>
